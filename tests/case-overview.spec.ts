...
test.describe('case management', async () => {
    test('As a web user, I am able to add a new case', async ({
      ...
      await page.type('[data-component="EmailField"] input', appSettings.webuser.username);
      await page.type('[data-component="Password"] input', appSettings.webuser.password);
      ...
      await page.type('[data-component="Number-case-number"] input', ('80694'));
      await page.waitForTimeout(1000);
   ...
   await loginUtils.goto(page, '/login');
      ...
      await page.waitForTimeout(1000);
      await page.type('[data-component="Update-case-number"] input', ('34'));
      await page.waitForTimeout(1000);
     ...
     test('As a web user, I am able to delete a case', async ({
    page,
  }) => {
    const loginUtils = new ExamUtils(page);  
